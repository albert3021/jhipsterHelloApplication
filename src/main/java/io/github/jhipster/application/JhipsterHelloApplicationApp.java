...
public class JhipsterHelloApplicationApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterHelloApplicationApp.class);

    private final Environment env;

    public JhipsterHelloApplicationApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterHelloApplication.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterHelloApplicationApp.class);
